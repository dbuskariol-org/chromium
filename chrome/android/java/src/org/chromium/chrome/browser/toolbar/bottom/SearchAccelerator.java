...
public class SearchAccelerator
        extends ImageButton implements ThemeColorObserver, TintObserver, IncognitoStateObserver {
    ...
    private void setProductInfoDrawable(String productName) {
        Drawable drawable =
                ApiCompatibilityUtils.getDrawable(getResources(), R.drawable.ic_logo_googleg_24dp);
        ...
        paint.setTextSize(
                1.2f * getResources().getDimension(R.dimen.compositor_tab_title_text_size));
