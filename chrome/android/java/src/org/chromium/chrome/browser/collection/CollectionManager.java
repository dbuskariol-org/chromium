...
/**
 * Manager class for collections feature.
 */
public class CollectionManager {
    ...
    private static boolean sCollectionManagerIsOn = true;
    ...
    static private final String sScript = "var overlayClassName = 'clank_shopping_overlay';\n"
    ...
    public static void turnOffCollectionManager() {
        sCollectionManagerIsOn = false;
    }
    ...
    public void toggleItem(String json) {
        ...
        if (!COLLECT_TO_LIST) {
            ...
            tab.getTabModelSelector().openNewTab(loadUrlParams,
                    TabLaunchType.FROM_LONGPRESS_BACKGROUND, tab, tab.isIncognito());
            closeBottomSheet();
    ...
    static public boolean isEnabled() {
        return sCollectionManagerIsOn
                && ChromeFeatureList.isEnabled(ChromeFeatureList.COLLECTION_FOR_SHOPPING);
    }
    ...
    private boolean isAllowedUrl(String url) {
        ...
        Log.e(TAG,
                "isAllowedUrl path = \"" + uri.getPath() + "\", query = \"" + uri.getQuery()
                        + "\"");
    ...
    private void showBottomSheet(FragmentManager fragmentManager) {
        if (mContent == null) {
            ...
            mToolbarView = LayoutInflater.from(mContext).inflate(
            ...
            */
            ...
            mContent = new CollectionBottomSheetContent(pager, mToolbarView);
        }
