...
void TabListSceneLayer::PutTabLayer(
  ...
  used_tints_.insert(selected_tab_border_color);
  ...
  if (layer) {
    ...
    layer->SetProperties(
        ...
        toolbar_y_offset, side_border_scale, inset_border, tab_ids,
        selected_tab_border_color);
  }
