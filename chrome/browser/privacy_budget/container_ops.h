...
namespace internal {
// Note that these only work for the restricted use cases within this directory.
...
//
// Returns true if any elements were moved.
template <typename T, class Predicate, typename V = typename T::value_type>
