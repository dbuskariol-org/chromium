...
#ifndef CHROME_BROWSER_UPBOARDING_QUERY_TILES_TILE_BACKGROUND_TASK_H_
#define CHROME_BROWSER_UPBOARDING_QUERY_TILES_TILE_BACKGROUND_TASK_H_
...
#endif  // CHROME_BROWSER_UPBOARDING_QUERY_TILES_TILE_BACKGROUND_TASK_H_
