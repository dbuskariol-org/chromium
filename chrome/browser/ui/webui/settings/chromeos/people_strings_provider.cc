...
PeopleStringsProvider::PeopleStringsProvider(
    Profile* profile,
...
void PeopleStringsProvider::AddUiStrings(
...
void PeopleStringsProvider::OnStateChanged(syncer::SyncService* sync_service) {
...
void PeopleStringsProvider::OnKerberosEnabledStateChanged() {
...
void PeopleStringsProvider::AddKerberosAccountsPageStrings(
...
bool PeopleStringsProvider::AreFingerprintSettingsAllowed() {
