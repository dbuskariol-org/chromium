...
DateTimeStringsProvider::DateTimeStringsProvider(Profile* profile,
...
DateTimeStringsProvider::~DateTimeStringsProvider() = default;

void DateTimeStringsProvider::AddUiStrings(
