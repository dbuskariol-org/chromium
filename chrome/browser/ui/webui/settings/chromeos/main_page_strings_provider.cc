...
MainPageStringsProvider::MainPageStringsProvider(Profile* profile,
                                                 Delegate* per_page_delegate)
    : OsSettingsPerPageStringsProvider(profile, per_page_delegate) {}

MainPageStringsProvider::~MainPageStringsProvider() = default;

void MainPageStringsProvider::AddUiStrings(
...
void MainPageStringsProvider::AddChromeOSUserStrings(
    content::WebUIDataSource* html_source) {
