...
PrivacyStringsProvider::PrivacyStringsProvider(Profile* profile,
...
PrivacyStringsProvider::~PrivacyStringsProvider() = default;

void PrivacyStringsProvider::AddUiStrings(
