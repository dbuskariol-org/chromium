...
#ifndef CHROME_BROWSER_UI_WEBUI_SETTINGS_CHROMEOS_PEOPLE_STRINGS_PROVIDER_H_
#define CHROME_BROWSER_UI_WEBUI_SETTINGS_CHROMEOS_PEOPLE_STRINGS_PROVIDER_H_
...
class PeopleStringsProvider : public OsSettingsPerPageStringsProvider,
                              public syncer::SyncServiceObserver,
                              public KerberosCredentialsManager::Observer {
 public:
  PeopleStringsProvider(
      Profile* profile,
      Delegate* per_page_delegate,
      syncer::SyncService* sync_service,
      SupervisedUserService* supervised_user_service,
      KerberosCredentialsManager* kerberos_credentials_manager);
  ~PeopleStringsProvider() override;
...
#endif  // CHROME_BROWSER_UI_WEBUI_SETTINGS_CHROMEOS_PEOPLE_STRINGS_PROVIDER_H_
