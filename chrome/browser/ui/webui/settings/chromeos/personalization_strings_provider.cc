...
PersonalizationStringsProvider::PersonalizationStringsProvider(
    Profile* profile,
  ...
  if (IsAmbientModeAllowed()) {
    ...
    pref_change_registrar_.Add(
        ...
        base::BindRepeating(
            &PersonalizationStringsProvider::OnAmbientModeEnabledStateChanged,
            base::Unretained(this)));
    OnAmbientModeEnabledStateChanged();
  }
}

PersonalizationStringsProvider::~PersonalizationStringsProvider() = default;

void PersonalizationStringsProvider::AddUiStrings(
...
void PersonalizationStringsProvider::OnAmbientModeEnabledStateChanged() {
