...
AboutPageStringsProvider::AboutPageStringsProvider(Profile* profile,
...
AboutPageStringsProvider::~AboutPageStringsProvider() = default;

void AboutPageStringsProvider::AddUiStrings(
