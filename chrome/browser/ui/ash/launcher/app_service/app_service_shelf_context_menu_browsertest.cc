...
class AppServiceShelfContextMenuWebAppBrowserTest
 ...
 public:
  ...
  MenuSection GetContextMenuSectionForAppCommand(const web_app::AppId& app_id,
                                                 int command_id) {
    MenuSection result;
    ...
    DCHECK(ui::MenuModel::GetModelAndIndexForCommandId(
...
IN_PROC_BROWSER_TEST_P(AppServiceShelfContextMenuWebAppBrowserTest,
  ...
  MenuSection menu_section = GetContextMenuSectionForAppCommand(
