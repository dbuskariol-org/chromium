...
/** @return {!Map<!settings.ContentSettingsTypes, !CategoryListItem>} */
...
Polymer({
  ...
  properties: {
    /** @private {!Array<!CategoryListItem>} */
    categoryList_: {
      type: Array,
      value: function() {
        const Id = settings.ContentSettingsTypes;
  ...
  updateDefaultValueLabel_(category, setting) {
    ...
    const subLabel = this.defaultSettingLabel_(
        setting, dataItem.enabledLabel ? this.i18n(dataItem.enabledLabel) : '',
