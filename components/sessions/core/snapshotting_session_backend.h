...
#ifndef COMPONENTS_SESSIONS_CORE_SNAPSHOTTING_SESSION_BACKEND_H_
#define COMPONENTS_SESSIONS_CORE_SNAPSHOTTING_SESSION_BACKEND_H_
...
// referred to as 'last'
class SESSIONS_EXPORT SnapshottingSessionBackend : public SessionBackend {
 public:
  ...
  SnapshottingSessionBackend(const SnapshottingSessionBackend&) = delete;
  SnapshottingSessionBackend& operator=(const SnapshottingSessionBackend&) =
      delete;
 ...
 private:
  friend class base::RefCountedDeleteOnSequence<SnapshottingSessionBackend>;
  friend class base::DeleteHelper<SnapshottingSessionBackend>;

  ~SnapshottingSessionBackend() override;
...
#endif  // COMPONENTS_SESSIONS_CORE_SNAPSHOTTING_SESSION_BACKEND_H_
