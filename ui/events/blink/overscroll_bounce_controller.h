...
#ifndef UI_EVENTS_BLINK_OVERSCROLL_BOUNCE_CONTROLLER_H_
#define UI_EVENTS_BLINK_OVERSCROLL_BOUNCE_CONTROLLER_H_
...
#endif  // UI_EVENTS_BLINK_OVERSCROLL_BOUNCE_CONTROLLER_H_
