vars = {
  'angle_revision':
    'af7f301f6ba9e5f31d1511142a936a9ba84169d0',
  'boringssl_git':
    'https://boringssl.googlesource.com',
  'boringssl_revision':
    'fc4467e5688d8f61b992684c2705e7934679d331',
  'buildspec_platforms':
    'win-clang,',
  'buildtools_revision':
    '1f985091a586bb6e95872d4d876b7d7fc57850d6',
  'catapult_revision':
    '3cb41d3b39dc4169ce21128b3a7359fe02bc4ba1',
  'chromium_git':
  ...
  'nacl_revision':
    '0ed980949e515a40fa79147e7f1cda70c56cf536',
  'openmax_dl_revision':
    '57d33bee7823e76393692f8d58e0478d6b79d153',
  'pdfium_git':
    'https://pdfium.googlesource.com',
  'pdfium_revision':
    '5c15e67e12e245d102a2e0ef1b4ade54379f252c',
  'sfntly_revision':
    '6e984975bf31b5a94fa3337dd56ab687bcee91c1',
  'skia_revision':
    '693a540272a771c6b0830094c461397cb77543b1',
  'swarming_revision':
    '380e32662312eb107f06fcba6409b0409f8fef72',
  'swiftshader_git':
    'https://swiftshader.googlesource.com',
  'swiftshader_revision':
    '8be4110779a653fe1ae051f089bce9340147a8d1',
  'v8_revision':
    'ebde8485b22d8dd90e73992719647ad744fb2914'
}
...
deps = {
  'src/breakpad/src':
    (Var("chromium_git")) + '/breakpad/breakpad/src.git@0e618edbe53593064efd4bfd9316d77731bdc593',
  'src/buildtools':
    (Var("chromium_git")) + '/chromium/buildtools.git@1f985091a586bb6e95872d4d876b7d7fc57850d6',
  ...
  'src/native_client':
    (Var("chromium_git")) + '/native_client/src/native_client.git@0ed980949e515a40fa79147e7f1cda70c56cf536',
  ...
  'src/third_party/angle':
    (Var("chromium_git")) + '/angle/angle.git@af7f301f6ba9e5f31d1511142a936a9ba84169d0',
  'src/third_party/bidichecker':
    (Var("chromium_git")) + '/external/bidichecker/lib.git@97f2aa645b74c28c57eca56992235c79850fa9e0',
  'src/third_party/boringssl/src':
    (Var("boringssl_git")) + '/boringssl.git@fc4467e5688d8f61b992684c2705e7934679d331',
  'src/third_party/catapult':
    (Var("chromium_git")) + '/external/github.com/catapult-project/catapult.git@3cb41d3b39dc4169ce21128b3a7359fe02bc4ba1',
  ...
  'src/third_party/libsrtp':
    (Var("chromium_git")) + '/chromium/deps/libsrtp.git@71692eaab2a06bbd87a551614a8791c7caa7e266',
  ...
  'src/third_party/pdfium':
    (Var("pdfium_git")) + '/pdfium.git@5c15e67e12e245d102a2e0ef1b4ade54379f252c',
  ...
  'src/third_party/sfntly/src':
    (Var("chromium_git")) + '/external/github.com/googlei18n/sfntly.git@6e984975bf31b5a94fa3337dd56ab687bcee91c1',
  ...
  'src/third_party/skia':
    (Var("chromium_git")) + '/skia.git@693a540272a771c6b0830094c461397cb77543b1',
  'src/third_party/smhasher/src':
    (Var("chromium_git")) + '/external/smhasher.git@e87738e57558e0ec472b2fc3a643b838e5b6e88f',
  'src/third_party/snappy/src':
    (Var("chromium_git")) + '/external/snappy.git@762bb32f0c9d2f31ba4958c7c0933d22e80c20bf',
  'src/third_party/swiftshader':
    (Var("swiftshader_git")) + '/SwiftShader.git@8be4110779a653fe1ae051f089bce9340147a8d1',
  ...
  'src/third_party/webrtc':
    (Var("chromium_git")) + '/external/webrtc/trunk/webrtc.git@215a597efed43e3e5117f6c3b63dbbcd955dedd9',
  ...
  'src/v8':
    (Var("chromium_git")) + '/v8/v8.git@ebde8485b22d8dd90e73992719647ad744fb2914'
}
...
deps_os = {
  ...
  'unix': {
    'src/third_party/chromite':
      (Var("chromium_git")) + '/chromiumos/chromite.git@39f0ff99d0ccd7c887800f4149e591f1226600c0',
