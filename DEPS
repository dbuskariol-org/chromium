vars = {
  ...
  'android_sdk_tools_version':
    'version:26.1.1-cr9',
  'angle_revision':
    'b221486a8dfd90214d2755edd61290b3f5e8c782',
  'aomedia_git':
  ...
  'buildspec_platforms':
    'win-asan',
  'buildtools_revision':
    'ab7b6a7b350dd15804c87c20ce78982811fdd76f',
  'catapult_revision':
    '846cec5c4d22e5f0e6f995a6af30eff5dbccebb6',
  ...
  'feed_revision':
    'a8ecfb5b2201743e69e4e2961571308975212ce2',
  'freetype_revision':
  ...
  'pdfium_revision':
    '52ab95aa3edbabbe90dcefcc54f3b6dace7ac53d',
  'sfntly_revision':
    '2804148152d27fa2e6ec97a32bc2d56318e51142',
  'skia_git':
    'https://skia.googlesource.com',
  'skia_revision':
    'a070ed7fccd8bc9c5f314e1a4ac090c497862836',
  'swarming_revision':
  ...
  'v8_revision':
    '24871c6b1ea211f8ee58cf17d4d09161362342b3',
  'webrtc_git':
...
deps = {
  'src-internal': {
    ...
    'url':
      'https://chrome-internal.googlesource.com/chrome/src-internal.git@3fd804ac57040882275c005e11c2ecc19f30d7cc'
  },
  'src/buildtools':
  ...
  'src/third_party/angle':
    (Var("chromium_git")) + '/angle/angle.git@b221486a8dfd90214d2755edd61290b3f5e8c782',
  ...
  'src/third_party/boringssl/src':
    (Var("boringssl_git")) + '/boringssl.git@9f0e7cb314ae64234b928fd379381ae9760a9a5f',
  ...
  'src/third_party/catapult':
    (Var("chromium_git")) + '/catapult.git@846cec5c4d22e5f0e6f995a6af30eff5dbccebb6',
  ...
  'src/third_party/chromite': {
    'condition':
      'checkout_linux',
    'url':
      (Var("chromium_git")) + '/chromiumos/chromite.git@74d7d171a121135f3a16daba6485e63e2fe6cc9f'
  },
  ...
  'src/third_party/depot_tools':
    (Var("chromium_git")) + '/chromium/tools/depot_tools.git@7580f9dac98552b038f9644cf9712f09712c7858',
  ...
  'src/third_party/feed/src': {
    'condition':
      'checkout_android',
    'url':
      (Var("chromium_git")) + '/feed@a8ecfb5b2201743e69e4e2961571308975212ce2'
  },
  ...
  'src/third_party/pdfium':
    (Var("pdfium_git")) + '/pdfium.git@52ab95aa3edbabbe90dcefcc54f3b6dace7ac53d',
  ...
  'src/third_party/skia':
    (Var("skia_git")) + '/skia.git@a070ed7fccd8bc9c5f314e1a4ac090c497862836',
  ...
  'src/third_party/webrtc':
    (Var("webrtc_git")) + '/src.git@e782abab190e0fb7afb501c470cf3d7fa8d5e7a9',
  ...
  'src/v8':
    (Var("chromium_git")) + '/v8/v8.git@24871c6b1ea211f8ee58cf17d4d09161362342b3'
}
...
hooks = [
  ...
  },
  {
    ...
    'condition':
      '(checkout_chromeos and host_os == "linux") and cros_download_vm'
  },
  {
    'action': [
      'src/third_party/chromite/bin/cros',
    ...
    'condition':
      '(checkout_chromeos and host_os == "linux") and not cros_download_vm'
  },
  {
    'action': [
      'vpython',
