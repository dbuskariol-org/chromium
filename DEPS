vars = {
  ...
  'v8_revision':
    '0b8651ca9ed0a692c111bf08ede1d3347e8c6a72'
}
...
deps = {
  ...
  'src/third_party/skia':
    (Var("skia_git")) + '/skia.git@f1bc5e8b78376e3b6509c8626623d3aae871daec',
  ...
  'src/v8':
    (Var("chromium_git")) + '/v8/v8.git@0b8651ca9ed0a692c111bf08ede1d3347e8c6a72'
}
