vars = {
  ...
  'android_sdk_tools_version':
    'version:26.1.1-cr9',
  'angle_revision':
    '03bb2231a821b2815a1ca472db47164af1350c6e',
  'aomedia_git':
  ...
  'catapult_revision':
    '153134ef26c384c98b9fd51b6281c4d5b932a7df',
  ...
  'pdfium_revision':
    'ad178855775da18d7abfadce4b64825f3e32adbd',
  'sfntly_revision':
    '2804148152d27fa2e6ec97a32bc2d56318e51142',
  'skia_git':
    'https://skia.googlesource.com',
  'skia_revision':
    '2f62de01d3a703696dc1a51d2473a88be68a7574',
  'swarming_revision':
  ...
  'v8_revision':
    '60da1b2e754e53a2134d56222d95f9c057ec65e0',
  'webrtc_git':
...
deps = {
  'src-internal': {
    ...
    'url':
      'https://chrome-internal.googlesource.com/chrome/src-internal.git@25309ca66e03592e029a2281e97036e109ebb113'
  },
  'src/buildtools':
  ...
  'src/third_party/android_ndk': {
    'condition':
      'checkout_android_native_support',
    'url':
      (Var("chromium_git")) + '/android_ndk.git@5cd86312e794bdf542a3685c6f10cbb96072990b'
  },
  ...
  'src/third_party/angle':
    (Var("chromium_git")) + '/angle/angle.git@03bb2231a821b2815a1ca472db47164af1350c6e',
  ...
  'src/third_party/boringssl/src':
    (Var("boringssl_git")) + '/boringssl.git@8e75ae488047c519f14f2c08b02a55bf7712fa1d',
  ...
  'src/third_party/catapult':
    (Var("chromium_git")) + '/catapult.git@153134ef26c384c98b9fd51b6281c4d5b932a7df',
  ...
  'src/third_party/chromite': {
    'condition':
      'checkout_linux',
    'url':
      (Var("chromium_git")) + '/chromiumos/chromite.git@8642bcc3248fa1a791d9c287420487c817782ae6'
  },
  ...
  'src/third_party/pdfium':
    (Var("pdfium_git")) + '/pdfium.git@ad178855775da18d7abfadce4b64825f3e32adbd',
  ...
  'src/third_party/skia':
    (Var("skia_git")) + '/skia.git@2f62de01d3a703696dc1a51d2473a88be68a7574',
  ...
  'src/third_party/webrtc':
    (Var("webrtc_git")) + '/src.git@a1f566b28a69512037e36f5194329d9ada46be01',
  ...
  'src/v8':
    (Var("chromium_git")) + '/v8/v8.git@60da1b2e754e53a2134d56222d95f9c057ec65e0'
}
...
hooks = [
  ...
  },
  {
    'action': [
      ...
      '--num_threads=4',
      '--bucket',
      'chromium-binary-patching/zucchini_testdata',
      '--recursive',
      '-d',
      'src/components/zucchini'
    ],
    'pattern':
      '.',
    'name':
