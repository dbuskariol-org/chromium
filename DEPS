vars = {
  'angle_revision':
    '875bbba0eeed060d479547c601707454689f98b5',
  'boringssl_git':
  ...
  'catapult_revision':
    '67cf0dc183f8a484495aa7eb1984f241835d01c1',
  'chromium_git':
  ...
  'pdfium_revision':
    '2eb1a705c243b2d5ab912268dd453f5ade075b6f',
  'scanbuild_revision':
  ...
  'skia_revision':
    'b43a3e0160b3854a04305decd1d9e766a3889b3a',
  'swarming_revision':
  ...
  'v8_revision':
    '65aae04bace3038b4323972547a94702b665bf83'
}
...
deps = {
  ...
  'src/third_party/angle':
    (Var("chromium_git")) + '/angle/angle.git@875bbba0eeed060d479547c601707454689f98b5',
  'src/third_party/bidichecker':
    (Var("chromium_git")) + '/external/bidichecker/lib.git@97f2aa645b74c28c57eca56992235c79850fa9e0',
  'src/third_party/boringssl/src':
    (Var("boringssl_git")) + '/boringssl.git@dc8c1d962e688c01cd8903d40ada70a75f700ad7',
  'src/third_party/catapult':
    (Var("chromium_git")) + '/external/github.com/catapult-project/catapult.git@67cf0dc183f8a484495aa7eb1984f241835d01c1',
  ...
  'src/third_party/pdfium':
    (Var("pdfium_git")) + '/pdfium.git@2eb1a705c243b2d5ab912268dd453f5ade075b6f',
  ...
  'src/third_party/skia':
    (Var("skia_git")) + '/skia.git@b43a3e0160b3854a04305decd1d9e766a3889b3a',
  'src/third_party/smhasher/src':
    (Var("chromium_git")) + '/external/smhasher.git@e87738e57558e0ec472b2fc3a643b838e5b6e88f',
  'src/third_party/snappy/src':
    (Var("chromium_git")) + '/external/snappy.git@762bb32f0c9d2f31ba4958c7c0933d22e80c20bf',
  'src/third_party/swiftshader':
    (Var("swiftshader_git")) + '/SwiftShader.git@12a2d0540ff67a8d640de8a22adc658fe307363c',
  ...
  'src/v8':
    (Var("chromium_git")) + '/v8/v8.git@65aae04bace3038b4323972547a94702b665bf83'
}
