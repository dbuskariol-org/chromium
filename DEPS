vars = {
  ...
  'android_sdk_tools_version':
    'version:26.1.1-cr9',
  'angle_revision':
    'e708f004bce5dc2ef7d33fd9572e9ca9a7e979ba',
  'aomedia_git':
    'https://aomedia.googlesource.com',
  'boringssl_git':
    'https://boringssl.googlesource.com',
  'boringssl_revision':
    'cece32610b89549386b42b2032dd5d8a423af6c8',
  'buildspec_platforms':
    'win-asan',
  'buildtools_revision':
    '0b71401b977fba99eb0c7bb01bdb3338f45bd911',
  'catapult_revision':
    '02bb4b7da4dbea61d40d2289bfb9d294616f76f3',
  ...
  'feed_revision':
    '1d9237605eab27bec2f052466efea004598ec6f8',
  'freetype_revision':
...
deps = {
  'src-internal': {
    ...
    'url':
      'https://chrome-internal.googlesource.com/chrome/src-internal.git@456cff40ed212e3de92d9a4374bd0c0217f8e851'
  },
  'src/buildtools':
  ...
  'src/ios/third_party/material_components_ios/src': {
    'condition':
      'checkout_ios',
    'url':
      (Var("chromium_git")) + '/external/github.com/material-components/material-components-ios.git@d7b1f39ad946be67cd6a83b6f9cd36b41f29a619'
  },
  ...
  'src/third_party/angle':
    (Var("chromium_git")) + '/angle/angle.git@e708f004bce5dc2ef7d33fd9572e9ca9a7e979ba',
  ...
  'src/third_party/arcore-android-sdk/src': {
    'condition':
      'checkout_android',
    'url':
      (Var("chromium_git")) + '/external/github.com/google-ar/arcore-android-sdk.git@772bed8e2e1bc525a0d10441fa71168a9a87eb69'
  },
  ...
  'src/third_party/boringssl/src':
    (Var("boringssl_git")) + '/boringssl.git@cece32610b89549386b42b2032dd5d8a423af6c8',
  ...
  'src/third_party/catapult':
    (Var("chromium_git")) + '/catapult.git@02bb4b7da4dbea61d40d2289bfb9d294616f76f3',
  ...
  'src/third_party/chromite': {
    'condition':
      'checkout_linux',
    'url':
      (Var("chromium_git")) + '/chromiumos/chromite.git@5295eaac6d224a44bac89b9b919bff2532ffcda4'
  },
  ...
  'src/third_party/cros_system_api': {
    'condition':
      'checkout_linux',
    'url':
      (Var("chromium_git")) + '/chromiumos/platform/system_api.git@d45ce7d902326cfba54645205c29d30ab8aabdb6'
  },
  'src/third_party/custom_tabs_client/src': {
    'condition':
      'checkout_android',
    'url':
      (Var("chromium_git")) + '/custom-tabs-client.git@fea7d0fe778ef486d4dbbdfa4b1c5f5bec9df186'
  },
  'src/third_party/depot_tools':
    (Var("chromium_git")) + '/chromium/tools/depot_tools.git@6c692edf010ce9e43737406c53f399b13631ac4f',
  ...
  'src/third_party/errorprone/lib': {
    'condition':
      'checkout_android',
    'url':
      (Var("chromium_git")) + '/chromium/third_party/errorprone.git@980d49e839aa4984015efed34b0134d4b2c9b6d7'
  },
  ...
  'src/third_party/feed/src': {
    'condition':
      'checkout_android',
    'url':
      (Var("chromium_git")) + '/feed@1d9237605eab27bec2f052466efea004598ec6f8'
  },
  ...
  'src/third_party/freetype/src':
    (Var("chromium_git")) + '/chromium/src/third_party/freetype2.git@2157d8fa6f7e12063ca166476ed2223d24234db7',
  ...
  'src/third_party/libFuzzer/src':
    (Var("chromium_git")) + '/chromium/llvm-project/compiler-rt/lib/fuzzer.git@fda403cf93ecb8792cb1d061564d89a6553ca020',
  ...
  'src/third_party/pdfium':
    (Var("pdfium_git")) + '/pdfium.git@6312bf94bb44e2edeb855008da0921c13103f66a',
  ...
  'src/third_party/skia':
    (Var("skia_git")) + '/skia.git@0caef298c2ff935b622673e09cd542151dc2ecc0',
  ...
  'src/third_party/swiftshader':
    (Var("swiftshader_git")) + '/SwiftShader.git@bf58b98950f4248f819bf3b2eaaf04b8663f4504',
  ...
  'src/third_party/webrtc':
    (Var("webrtc_git")) + '/src.git@6f7e6d6ff3533557ef99a0ceb01850f1fef071b3',
  ...
  'src/v8':
    (Var("chromium_git")) + '/v8/v8.git@f93c127f78918dc364bc766b77c75776a0900b48'
}
...
hooks = [
  ...
  },
  {
    ...
    'pattern':
      '.',
    'name':
      'cros_simplechrome_artifacts_with_vm',
    'condition':
      '((checkout_chromeos and host_os == "linux") and cros_download_vm) and ("{cros_board}" != "")'
  },
  {
    'action': [
      'src/third_party/chromite/bin/cros',
    ...
    'pattern':
      '.',
    'name':
      'cros_simplechrome_artifacts_with_no_vm',
    'condition':
      '((checkout_chromeos and host_os == "linux") and not cros_download_vm) and ("{cros_board}" != "")'
  },
  {
    'action': [
      'vpython',
