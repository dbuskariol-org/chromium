vars = {
  ...
  'v8_revision':
    '2d681236bed24bc427694249495c786444bd1bca'
}
...
deps = {
  ...
  'src/third_party/skia':
    (Var("skia_git")) + '/skia.git@58cda8fa495225bbcb3d93bdd7f81ec515402475',
  ...
  'src/v8':
    (Var("chromium_git")) + '/v8/v8.git@2d681236bed24bc427694249495c786444bd1bca'
}
