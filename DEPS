...
deps = {
  ...
  'src/third_party/ffmpeg': {
    'url':
      '{chromium_git}/chromium/third_party/ffmpeg.git@b4b8c532ccce50384c05a3436c4da3a8084c82cd'
  },
  ...
  'src/third_party/pdfium': {
    'url':
      '{pdfium_git}/pdfium.git@6d69dfca14621c907ca9d6c6bd3d3a5d4428e85b'
  },
  ...
  'src/third_party/webrtc': {
    'url':
      '{webrtc_git}/src.git@36af4e9614f707f733eb2340fae66d6325aaac5b'
  },
  ...
  'src/v8': {
    'url':
      '{chromium_git}/v8/v8.git@70d97563ece35839be7616ca9887a6ce83f15754'
  }
}
