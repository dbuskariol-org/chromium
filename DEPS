vars = {
  ...
  'v8_revision':
    'bf07eadc7055c5a2ea96379199a63b9046ac54bb'
}
...
deps = {
  ...
  'src/third_party/skia':
    (Var("skia_git")) + '/skia.git@50b2084bd15e7aea416dc8c6fd2373864c50f023',
  ...
  'src/v8':
    (Var("chromium_git")) + '/v8/v8.git@bf07eadc7055c5a2ea96379199a63b9046ac54bb'
}
