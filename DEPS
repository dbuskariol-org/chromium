vars = {
  ...
  'buildspec_platforms':
    'win, ios, chromeos, win_recipes, win64, android, mac64',
  'buildtools_revision':
    '1dcd1bdbe93467531a50b60dbd18860803ca7be1',
  'catapult_revision':
    '6539cc70d9e1b8b9c67a3b7ff6a1a0da7a5a961d',
  'chromium_git':
  ...
  'pdfium_revision':
    '1f9d2338feb75d62bb28e116df7243dd567fded8',
  'sfntly_revision':
    '2439bd08ff93d4dce761dd6b825917938bd35a4f',
  'skia_git':
    'https://skia.googlesource.com',
  'skia_revision':
    'c867a89b012c07e7e5cb719a31ed90e61f4a4901',
  'swarming_revision':
...
deps = {
  ...
  'src/third_party/catapult':
    (Var("chromium_git")) + '/external/github.com/catapult-project/catapult.git@6539cc70d9e1b8b9c67a3b7ff6a1a0da7a5a961d',
  ...
  'src/third_party/pdfium':
    (Var("pdfium_git")) + '/pdfium.git@1f9d2338feb75d62bb28e116df7243dd567fded8',
  ...
  'src/third_party/skia':
    (Var("skia_git")) + '/skia.git@c867a89b012c07e7e5cb719a31ed90e61f4a4901',
