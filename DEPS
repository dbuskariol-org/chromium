vars = {
  ...
  'nacl_revision':
    'd26dd9f685f430e237195ff9c0525fd97df60617',
  'nss_revision':
    '225bfc39c93dfb7c7d0d1162f81e9bb5cd356c30',
  'openmax_dl_revision':
    '6670e52d32351145a6b6c198dab3f6a536edf3db',
  'pdfium_revision':
    '30410cecd0f2653556094a20c2564170be127127',
  'sfntly_revision':
  ...
  'v8_revision':
    'eaa2e51488f43d813f3c5c7423e376f48a4baba9'
}
...
deps = {
  ...
  'src/native_client':
    (Var("chromium_git")) + '/native_client/src/native_client.git@d26dd9f685f430e237195ff9c0525fd97df60617',
  ...
  'src/third_party/catapult':
    (Var("chromium_git")) + '/external/github.com/catapult-project/catapult.git@468628c224cf05df4e6ede5e00070f5f7c4e0e70',
  ...
  'src/third_party/libjingle/source/talk':
    (Var("chromium_git")) + '/external/webrtc/trunk/talk.git@a63b8486770e5da74891e146d1a7ebdf737bf034',
  ...
  'src/third_party/pdfium':
    'https://pdfium.googlesource.com/pdfium.git@30410cecd0f2653556094a20c2564170be127127',
  ...
  'src/third_party/skia':
    (Var("chromium_git")) + '/skia.git@bf680c30a280d4d7b3b8d5fedf23defff348cb50',
  ...
  'src/third_party/webrtc':
    (Var("chromium_git")) + '/external/webrtc/trunk/webrtc.git@addc0e6bc9ccbfa142ea1bc46d34456404bf28ac',
  ...
  'src/v8':
    (Var("chromium_git")) + '/v8/v8.git@eaa2e51488f43d813f3c5c7423e376f48a4baba9'
}
...
deps_os = {
  'android': {
    ...
    'src/third_party/android_tools':
      (Var("chromium_git")) + '/android_tools.git@f06598e6d8dbb275b9a9fd83d80be53207d48c45',
...
hooks = [
  ...
  },
  {
    'action': [
      ...
      '--revision=5fba5ecd49dc7162686ab85b912d7188e9964b60',
      '--overwrite'
    ],
    'pattern':
      '.',
