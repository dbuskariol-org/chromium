vars = {
  'angle_revision':
    '9df395c86494d760fb4caf20177ad7b6d1ca2b3f',
  'boringssl_git':
    'https://boringssl.googlesource.com',
  'boringssl_revision':
    '683ffbbe57de2163b24993e0d03650cf393bc640',
  'buildspec_platforms':
    'win-clang',
  'buildtools_revision':
    'cbc33b9c0a9d1bb913895a4319a742c504a2d541',
  'catapult_revision':
    '49fbcfa16b5d148a595cc50036d5e8354739f13f',
  'chromium_git':
  ...
  'skia_revision':
    'db91c6e7fbfc9d1d8fd203f7e08eefb602e4a0b9',
  'swarming_revision':
  ...
  'v8_revision':
    'ec37390b2ba2b4051f46f153a8cc179ed4656f5d'
}
...
deps = {
  ...
  'src/third_party/angle':
    (Var("chromium_git")) + '/angle/angle.git@9df395c86494d760fb4caf20177ad7b6d1ca2b3f',
  'src/third_party/bidichecker':
    (Var("chromium_git")) + '/external/bidichecker/lib.git@97f2aa645b74c28c57eca56992235c79850fa9e0',
  'src/third_party/boringssl/src':
    (Var("boringssl_git")) + '/boringssl.git@683ffbbe57de2163b24993e0d03650cf393bc640',
  'src/third_party/catapult':
    (Var("chromium_git")) + '/external/github.com/catapult-project/catapult.git@49fbcfa16b5d148a595cc50036d5e8354739f13f',
  ...
  'src/third_party/pdfium':
    (Var("pdfium_git")) + '/pdfium.git@5b2092a1ec59077b430bd2cab91554cad2eb5128',
  ...
  'src/third_party/skia':
    (Var("skia_git")) + '/skia.git@db91c6e7fbfc9d1d8fd203f7e08eefb602e4a0b9',
  ...
  'src/v8':
    (Var("chromium_git")) + '/v8/v8.git@ec37390b2ba2b4051f46f153a8cc179ed4656f5d'
}
