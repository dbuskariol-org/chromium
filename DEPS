vars = {
  ...
  'angle_revision':
    '95ed19473fb658b18001d5ef1bf782563151aed1',
  'aomedia_git':
  ...
  'buildspec_platforms':
    'win, ios, linux64, win64, android, mac64',
  'buildtools_revision':
    'f115f4786771afdfacb18a2299541b23e21f4792',
  'catapult_revision':
    '744dac91365202b997369e957c372a80ed71a1ea',
  ...
  'nacl_revision':
    '476698afdd0b114d72e6b4bde36691e5cc8b0bd6',
  'openmax_dl_revision':
    'b611996df3b8f6b151339d22c12c21f167009cb6',
  'pdfium_git':
    'https://pdfium.googlesource.com',
  'pdfium_revision':
    '59790cef1a09565e8b6799141cf45455ef2dc752',
  'sfntly_revision':
  ...
  'v8_revision':
    'ad9e8781a2310e4cae17b60c68d9ebf835663c0a',
  'webrtc_git':
...
deps = {
  'src-internal': {
    ...
    'url':
      'https://chrome-internal.googlesource.com/chrome/src-internal.git@339865817c04461de02ddf3366a5f69f73f28371'
  },
  'src/buildtools':
  ...
  'src/clank': {
    'condition':
      'checkout_android and checkout_google_internal',
    'url':
      'https://chrome-internal.googlesource.com/clank/internal/apps.git@c19fd1f58360175e69e799a745500f2fb8ab9306'
  },
  ...
  'src/ios_internal': {
    'condition':
      'checkout_ios and checkout_google_internal',
    'url':
      'https://chrome-internal.googlesource.com/chrome/ios_internal.git@64a5bc12e5a49152061be79503371ce79b016ddb'
  },
  'src/media/cdm/api':
  ...
  'src/native_client': {
    'condition':
      'checkout_nacl',
    'url':
      (Var("chromium_git")) + '/native_client/src/native_client.git@476698afdd0b114d72e6b4bde36691e5cc8b0bd6'
  },
  'src/signing_keys': {
    'condition':
      'checkout_android and checkout_google_internal',
    'url':
      'https://chrome-internal.googlesource.com/clank/apptestkey.git@5138e684915721cbccbb487ec0764ed05650fcd0'
  },
  ...
  'src/third_party/android_tools_internal': {
    'condition':
      'checkout_android and checkout_google_internal',
    'url':
      'https://chrome-internal.googlesource.com/clank/third_party/android_tools.git@bf7db506ef9a2f97775fa36d4572cecad575fc4e'
  },
  'src/third_party/angle':
    (Var("chromium_git")) + '/angle/angle.git@95ed19473fb658b18001d5ef1bf782563151aed1',
  ...
  'src/third_party/boringssl/src':
    (Var("boringssl_git")) + '/boringssl.git@7e5dd25d47face6deb452823ae4f40c4c7ca375a',
  'src/third_party/breakpad/breakpad':
    (Var("chromium_git")) + '/breakpad/breakpad.git@ac4a549e29fbc8fe58212380e41fa24f36e6c3ec',
  'src/third_party/catapult':
    (Var("chromium_git")) + '/catapult.git@744dac91365202b997369e957c372a80ed71a1ea',
  ...
  'src/third_party/chromite': {
    'condition':
      'checkout_linux',
    'url':
      (Var("chromium_git")) + '/chromiumos/chromite.git@5b16d08cfaf8b1fc689a9c68258c258f4ad0fff8'
  },
  ...
  'src/third_party/cros_system_api': {
    'condition':
      'checkout_linux',
    'url':
      (Var("chromium_git")) + '/chromiumos/platform/system_api.git@03017732129da58164ffd1e31c7c050abc797e89'
  },
  ...
  'src/third_party/freetype/src':
    (Var("chromium_git")) + '/chromium/src/third_party/freetype2.git@994eb2b34934bc5face9f83b2d3b12cf7a9262ab',
  ...
  'src/third_party/pdfium':
    (Var("pdfium_git")) + '/pdfium.git@59790cef1a09565e8b6799141cf45455ef2dc752',
  ...
  'src/third_party/sfntly/src':
    (Var("chromium_git")) + '/external/github.com/googlei18n/sfntly.git@16f3404e41edc9708a51fbce481f22e46b809686',
  ...
  'src/third_party/skia':
    (Var("skia_git")) + '/skia.git@e45d32abe13239e3482fc4a13f006ab72073252a',
  ...
  'src/third_party/webrtc':
    (Var("webrtc_git")) + '/src.git@5f94aa2c013e5a09ab17cec76b104879d059af2a',
  ...
  'src/v8':
    (Var("chromium_git")) + '/v8/v8.git@ad9e8781a2310e4cae17b60c68d9ebf835663c0a'
}
