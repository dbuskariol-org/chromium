...
vars = {
  ...
  'skia_revision': '37e7b36a3dc24c6547968ca1bc3e5e8b764bf176',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@5e883773e98ed67c74c5f92566f1f62f3b91455e',
