vars = {
  'angle_revision':
    '09cfac606ef5ca64cb657fd03cbc110a44c34fe6',
  'boringssl_revision':
  ...
  'catapult_revision':
    '7eb57a1834937c2af3eb23efab0d8fa4ec987800',
  'chromium_git':
...
deps = {
  ...
  'src/native_client':
    (Var("chromium_git")) + '/native_client/src/native_client.git@fe5bd51f9b79d27b2a3884181d4004cfccf70759',
  ...
  'src/third_party/angle':
    (Var("chromium_git")) + '/angle/angle.git@09cfac606ef5ca64cb657fd03cbc110a44c34fe6',
  'src/third_party/bidichecker':
    (Var("chromium_git")) + '/external/bidichecker/lib.git@97f2aa645b74c28c57eca56992235c79850fa9e0',
  'src/third_party/boringssl/src':
    'https://boringssl.googlesource.com/boringssl.git@ed6c5d39100fce575ef6c94b12c43f25c55d4205',
  'src/third_party/catapult':
    (Var("chromium_git")) + '/external/github.com/catapult-project/catapult.git@7eb57a1834937c2af3eb23efab0d8fa4ec987800',
  ...
  'src/third_party/libvpx/source/libvpx':
    (Var("chromium_git")) + '/webm/libvpx.git@4282d29355df3b72372669fe3b745c753dfe1c7d',
  ...
  'src/third_party/pdfium':
    'https://pdfium.googlesource.com/pdfium.git@cde5101eb15b24519e89fa500fe37038bc8e2201',
  ...
  'src/third_party/skia':
    (Var("chromium_git")) + '/skia.git@262052c9261a567f937ae05ade11ea7a3d280f4c',
  'src/third_party/smhasher/src':
    (Var("chromium_git")) + '/external/smhasher.git@e87738e57558e0ec472b2fc3a643b838e5b6e88f',
  'src/third_party/snappy/src':
    (Var("chromium_git")) + '/external/snappy.git@762bb32f0c9d2f31ba4958c7c0933d22e80c20bf',
  'src/third_party/swiftshader':
    'https://swiftshader.googlesource.com/SwiftShader.git@8be4110779a653fe1ae051f089bce9340147a8d1',
  ...
  'src/third_party/webgl/src':
    (Var("chromium_git")) + '/external/khronosgroup/webgl.git@65c5e7b16e98cbb998f742c45f9233f6f038c5c6',
  ...
  'src/v8':
    (Var("chromium_git")) + '/v8/v8.git@ad5be95d94dfa6c339d32b0d3b3fa22eb924e829'
}
