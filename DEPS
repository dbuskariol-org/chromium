vars = {
  ...
  'angle_revision':
    '0ce016c1bd12916c0d30c0ded96b29681a9e4d09',
  'aomedia_git':
  ...
  'buildspec_platforms':
    'all',
  'buildtools_revision':
    '10d701fce52d192005512aa832dc82f9aae72b5d',
  'catapult_revision':
    'b5c70ce2580e8efd7c263a9d50123907e2cb62e7',
  ...
  'pdfium_revision':
    'e372ad7333bdd6bb0c579cf074843ef0c6f3414f',
  'sfntly_revision':
    '2804148152d27fa2e6ec97a32bc2d56318e51142',
  'skia_git':
    'https://skia.googlesource.com',
  'skia_revision':
    '1eeeae0491bac9ee76e785245f4a6aaa11f7a540',
  'swarming_revision':
  ...
  'v8_revision':
    '6bd23308a5bc551f776412048df5feb502acc016',
  'webrtc_git':
...
deps = {
  'src-internal': {
    ...
    'url':
      'https://chrome-internal.googlesource.com/chrome/src-internal.git@b59810f75793af13e75f3bc7b0ca8e2101323d3b'
  },
  'src/buildtools':
  ...
  'src/ios/third_party/material_components_ios/src': {
    'condition':
      'checkout_ios',
    'url':
      (Var("chromium_git")) + '/external/github.com/material-components/material-components-ios.git@8c8aad6dc245a6682544952e9d47c44149bffb33'
  },
  ...
  'src/third_party/angle':
    (Var("chromium_git")) + '/angle/angle.git@0ce016c1bd12916c0d30c0ded96b29681a9e4d09',
  ...
  'src/third_party/catapult':
    (Var("chromium_git")) + '/catapult.git@b5c70ce2580e8efd7c263a9d50123907e2cb62e7',
  ...
  'src/third_party/chromite': {
    'condition':
      'checkout_linux',
    'url':
      (Var("chromium_git")) + '/chromiumos/chromite.git@02ef76b018ac321d5ac7e2b068823dbf177b522f'
  },
  ...
  'src/third_party/pdfium':
    (Var("pdfium_git")) + '/pdfium.git@e372ad7333bdd6bb0c579cf074843ef0c6f3414f',
  ...
  'src/third_party/skia':
    (Var("skia_git")) + '/skia.git@1eeeae0491bac9ee76e785245f4a6aaa11f7a540',
  ...
  'src/v8':
    (Var("chromium_git")) + '/v8/v8.git@6bd23308a5bc551f776412048df5feb502acc016'
}
