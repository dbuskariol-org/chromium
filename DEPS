vars = {
  ...
  'angle_revision':
    '822a84b1959f9c1bb615ad4dff2569c58fb3b225',
  'aomedia_git':
  ...
  'catapult_revision':
    'bffbf166f004d3d44f13cc4672674ca580e09a49',
  ...
  'pdfium_revision':
    '3ae75c2f2e5759fcf8218e59fa380c26b98aa6b6',
  'sfntly_revision':
    '2804148152d27fa2e6ec97a32bc2d56318e51142',
  'skia_git':
    'https://skia.googlesource.com',
  'skia_revision':
    '103e7243718a0ba9d4ede671b9c1ac7207d68786',
  'swarming_revision':
  ...
  'v8_revision':
    '5d39e8a4bd5681f7b1e1fd4cd7ee2b99bea47aed',
  'webrtc_git':
...
deps = {
  ...
  'src/third_party/angle':
    (Var("chromium_git")) + '/angle/angle.git@822a84b1959f9c1bb615ad4dff2569c58fb3b225',
  ...
  'src/third_party/catapult':
    (Var("chromium_git")) + '/catapult.git@bffbf166f004d3d44f13cc4672674ca580e09a49',
  ...
  'src/third_party/chromite': {
    'condition':
      'checkout_linux',
    'url':
      (Var("chromium_git")) + '/chromiumos/chromite.git@44123785ca9a78989d225628ee44d5bc1825439c'
  },
  ...
  'src/third_party/cros_system_api': {
    'condition':
      'checkout_linux',
    'url':
      (Var("chromium_git")) + '/chromiumos/platform/system_api.git@a0f6142f5733313cdb84337afc93bbd55f8ba344'
  },
  ...
  'src/third_party/pdfium':
    (Var("pdfium_git")) + '/pdfium.git@3ae75c2f2e5759fcf8218e59fa380c26b98aa6b6',
  ...
  'src/third_party/skia':
    (Var("skia_git")) + '/skia.git@103e7243718a0ba9d4ede671b9c1ac7207d68786',
  ...
  'src/third_party/webrtc':
    (Var("webrtc_git")) + '/src.git@dc4737bbdacc7ff662af0f0c33ac9bb8a5ddb28b',
  ...
  'src/v8':
    (Var("chromium_git")) + '/v8/v8.git@5d39e8a4bd5681f7b1e1fd4cd7ee2b99bea47aed'
}
