vars = {
  ...
  'catapult_revision':
    '2dd86f198093f8c64411ad6d74b5d5e6c26c367f',
  'chromium_git':
  ...
  'pdfium_revision':
    'f11380fc01cc17f05a34859d34c42b495c8ef8be',
  'sfntly_revision':
    '64f78562d2003eb7cacaaa86a398cbd41881ba6f',
  'skia_git':
    'https://skia.googlesource.com',
  'skia_revision':
    '56b50792531c956be3e0c472b098255c62c7e755',
  'swarming_revision':
  ...
  'v8_revision':
    'f796cb3f3d633f673ec266f1d5fdd277ab66e967'
}
...
deps = {
  ...
  'src/third_party/catapult':
    (Var("chromium_git")) + '/external/github.com/catapult-project/catapult.git@2dd86f198093f8c64411ad6d74b5d5e6c26c367f',
  ...
  'src/third_party/pdfium':
    (Var("pdfium_git")) + '/pdfium.git@f11380fc01cc17f05a34859d34c42b495c8ef8be',
  ...
  'src/third_party/skia':
    (Var("skia_git")) + '/skia.git@56b50792531c956be3e0c472b098255c62c7e755',
  ...
  'src/v8':
    (Var("chromium_git")) + '/v8/v8.git@f796cb3f3d633f673ec266f1d5fdd277ab66e967'
}
...
hooks = [
  ...
  },
  {
    'action': [
      ...
      '--revision=674d8e96b0997b57280589534474dc09d95970d8',
      '--overwrite',
      '--copy-dia-binaries'
    ],
    'pattern':
