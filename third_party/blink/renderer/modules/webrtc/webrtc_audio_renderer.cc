...
WebRtcAudioRenderer::WebRtcAudioRenderer(
  ...
  if (speech_recognition_client_ &&
    ...
    // Unretained is safe since the callback is only ever called by |this|.
    transcribe_audio_callback_ = media::BindToCurrentLoop(WTF::BindRepeating(
        &WebRtcAudioRenderer::TranscribeAudio, WTF::Unretained(this)));
  }
