...
const CSSPropertyID kComputedPropertyArray[] = {
    ...
    CSSPropertyID::kBorderBottomColor, CSSPropertyID::kBorderBottomLeftRadius,
    ...
    CSSPropertyID::kJustifyContent, CSSPropertyID::kJustifyItems,
    CSSPropertyID::kJustifySelf, CSSPropertyID::kLeft,
    CSSPropertyID::kLetterSpacing, CSSPropertyID::kLightingColor,
    CSSPropertyID::kLineBreak, CSSPropertyID::kLineHeight,
    ...
    CSSPropertyID::kMarkerStart, CSSPropertyID::kMask,
    CSSPropertyID::kMaskSourceType, CSSPropertyID::kMaskType,
    CSSPropertyID::kMathStyle, CSSPropertyID::kMathSuperscriptShiftStyle,
    ...
    CSSPropertyID::kPaintOrder, CSSPropertyID::kPerspective,
    CSSPropertyID::kPerspectiveOrigin, CSSPropertyID::kPointerEvents,
    CSSPropertyID::kPosition, CSSPropertyID::kR, CSSPropertyID::kResize,
    CSSPropertyID::kRight, CSSPropertyID::kRotate, CSSPropertyID::kRowGap,
    CSSPropertyID::kRx, CSSPropertyID::kRy, CSSPropertyID::kScale,
